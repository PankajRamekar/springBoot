package com.te.testspringboot.mockito.list;
...
public class ListTest {
	...
	public void list_onAnyIndex() {
		...
		assertEquals("Hi", mock.get(anyInt()));
	}

	public void list_multipleReturns() {
	...
	public void list_timesCall() {
		...
		verify(mock, atMost(10)).get(anyInt());
	}
